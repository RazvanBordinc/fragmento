...
export default function ProfilePage() {
  ...
  const [userData, setUserData] = useState({
    ...
    signatureFragrance: {
      ...
      description:
        "My daily go-to fragrance. The perfect balance between freshness and masculinity.",
      notes: ["Sage", "Lavender", "Geranium", "Cedar", "Olibanum"],
    },
  });
      ...
      <div className="max-w-4xl mx-auto px-4 flex justify-between items-center mb-6">
        <div className="flex space-x-2">
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-orange-600 text-white font-medium cursor-pointer"
        ...
        <div className="relative">
          <motion.button
            ...
            className="p-2 rounded-full hover:bg-zinc-700 transition-colors cursor-pointer"
...
const sampleFollowing = [
  {
    ...
    username: "perfumemaster",
    profilePic: null,
    followedAt: "2023-07-05T09:22:18Z",
  },
  {
    id: "user999",
    username: "fragranceboutique",
    profilePic: null,
    followedAt: "2023-06-30T16:45:09Z",
  },
];
